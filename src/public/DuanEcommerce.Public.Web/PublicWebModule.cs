...
public class PublicWebModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                options.FileSets.ReplaceEmbeddedByPhysical<DuanEcommerceDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}common{Path.DirectorySeparatorChar}domain{Path.DirectorySeparatorChar}DuanEcommerce.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<DuanEcommerceDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}common{Path.DirectorySeparatorChar}domain{Path.DirectorySeparatorChar}DuanEcommerce.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<PublicApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}DuanEcommerce.Public.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<PublicApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}DuanEcommerce.Public.Application"));
                options.FileSets.ReplaceEmbeddedByPhysical<PublicHttpApiModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}DuanEcommerce.Public.HttpApi"));

...
public class DuanEcommerceDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        DuanEcommerceGlobalFeatureConfigurator.Configure();
        DuanEcommerceModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<DuanEcommerceDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<DuanEcommerceResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/DuanEcommerce");

            options.DefaultResourceType = typeof(DuanEcommerceResource);
        ...
        {
            options.MapCodeNamespace("DuanEcommerce", typeof(DuanEcommerceResource));
        });
    }
}
